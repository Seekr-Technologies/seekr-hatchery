...
# Appended to Claude Code's default system prompt (preserving its built-in
...
def write_task_file(worktree: Path, name: str, branch: str, objective: str | None = None) -> Path:
    claude_tasks = worktree / ".hatchery" / "tasks"
    claude_tasks.mkdir(parents=True, exist_ok=True)
    task_path = claude_tasks / task_file_name(name)
...
TODO: any background, links, or constraints Claude should know about
